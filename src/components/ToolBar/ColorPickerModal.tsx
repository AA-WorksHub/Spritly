...
export const ColorPickerModal: React.FC<ColorPickerModalProps> = ({
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed top-1/2 left-1/6 transform -translate-x-1/2 -translate-y-1/2 z-50 bg-white rounded-lg shadow-2xl p-6 w-96">
        {/* Header */}
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold text-slate-800">Choisir une couleur</h3>
          <button
            onClick={onClose}
