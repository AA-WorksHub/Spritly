...
function LayersPanel() {
    ...
    return (
        <div className="w-64 bg-gray-800 border-l border-gray-700 flex flex-col shrink-0 z-10">
            <div className="h-10 px-3 bg-gray-900 flex items-center justify-between border-b border-gray-700">
                <div className="flex items-center gap-2 text-gray-400">
                    <Layers size={16} />
                    <span className="text-xs font-bold uppercase tracking-wider">Calques</span>
                </div>
                <button onClick={addLayer} className="text-gray-400 hover:text-white p-1 hover:bg-gray-700 rounded">
                    <Plus size={16} />
                </button>
            </div>
